...
export NAVSIM_FLOW_RGB_CACHE_DIR="${NAVSIM_FLOW_RGB_CACHE_DIR:-/mnt/zhaozc_workspace/data/fastwam_xty_dpflow_rgb_dataset_official_192x352_fg_residual_q92}"

export NPROC_PER_NODE="${NPROC_PER_NODE:-16}"
NUM_MACHINES="${FASTWAM_NUM_MACHINES:-${NNODES:-1}}"
HOST_NAME="$(hostname)"
if [[ -z "${NODE_RANK:-}" ]]; then
...
TASK_BASENAME="${TASK_BASENAME:-navsim_uncond_front_192x352_xty_dit_16gpu_masked_flow}"
