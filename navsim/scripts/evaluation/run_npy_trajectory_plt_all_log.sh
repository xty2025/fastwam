...
PRED_ACTIONS_PATH="$NAVSIM_EXP_ROOT/navsim/navsim_uncond_front_384x512_1e-4/step_008000/20260524_190639/pred_actions"
SPLIT="test"
FILTER="navtest"
PLOT_MODE="bev_camera"
OUTPUT_DIR="$NAVSIM_EXP_ROOT/navsim/navsim_uncond_front_384x512_1e-4/step_008000/20260524_190639/plt_all_log"
python "$NAVSIM_DEVKIT_ROOT/navsim/planning/script/plt_all_log.py" \
